...
To Access the Admin dashboard, go to [your-domain.com/login.php](http://your-domain.com/login.php) then, you will be shown the below screen, Enter your Admin Account login details to login
