...
To Intergrate Kiwiwall offerwall, you’ll need the following Ids :
...
1. Login into your **_Kiwiwall DashBoard_**, you'll find the below page, then go to **Create App**

![Kiwi Wall 1 Pn](/images/kiwi_wall_1.png)

1. Create a New App, URL and fill out the form

![Kiwi Wall 2 Pn](/images/kiwi_wall_2.png)

1. Then your app will be created and shown like below...

![Kiwi Wall 3 Pn](/images/kiwi_wall_3.png)

1. Copy the **Wall Id, Api Key** and **Secret Key **and paste it in your `Admin Panel --> Settings --> OfferWalls --> KiwiWall`
