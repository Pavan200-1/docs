...
description: "Find more info here on adding AdMantum"
---
...
Give your App Details. like below and save it. You'll find your Postback URL in your **Admin Panel --\> Settings --\> Postbacks S2S**
...
Copy the pub id, app id and secretkey and paste it in your **Admin Panel --\> Settings --\> OfferWalls --\> AdMantum**

<Check>
  Note : Here your App Status is on Testing Mode, To Make it to go in Live mode, we need to do a postback test Successfully. After that your app will go into Live Mode and starts Making Money\!
</Check>
