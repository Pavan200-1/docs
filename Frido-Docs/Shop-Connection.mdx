...
1. Once the connection is established, the platform will display the specific permissions it has been granted. A green checkmark and the text **"Your data is secure"** confirm the secure connection.
