...
### Updating Pocket GPT Script

> WARNING : This Step is not Needed for FRESH Installation

Download the new update from DroidOXY and Extract the archive file, when done, you should see **Update** Folder _(zip file name can be changed from version to version)_.
