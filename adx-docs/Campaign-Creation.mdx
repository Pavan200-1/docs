---
description: "Getting Started with creating a new campaign on your platform.  Follow these steps to set up your campaign and get it ready to go live."
title: "Campaign Creation"
---

## How to Create a Campaign ?

Campaigns are used in marketing and sales to promote products, build brand awareness, engage with audiences, or drive conversions. It helps you track the performance of your affiliate marketing activities and generate sales.

#### **Steps to Create a Campaign**

1. Click on the **Campaigns** tab in the top navigation menu or Navigate to the `Create -> New Campaign` page to begin.
2. Click the **Add Campaign** button to open the creation form.

   ![Admin Campaigns Youth Needs 09 30 2025 12 16 PM Pn](/images/Admin-Campaigns-YouthNeeds-09-30-2025_12_16_PM.png)
