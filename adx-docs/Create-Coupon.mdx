...
- To link the coupon to an existing, defined marketing campaign (e.g., "Holiday Sale 2025").
- Enter the unique ID or name of the campaign you wish to associate this coupon (e.g., "1234").
