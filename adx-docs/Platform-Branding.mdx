...
description: "Platform Branding is the process of customizing the platform with your preferred colors, logo, and settings."
---

### Platform Branding

- **Brand Logo :** Primary logo displayed throughout the platform.
  - Dark Logo : PNG or JPG image of 250px width and 80px height (250x80px)
  - Light Logo : PNG or JPG image ( 250x80px)
